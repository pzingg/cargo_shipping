defmodule CargoShipping.CargoInspectionService do
  ...
  def inspect_cargo(tracking_id) do
    ...
    delivery = CargoBookings.derive_delivery_progress(cargo, handling_history)
    {:ok, inspected_cargo} = CargoBookings.update_cargo(cargo, %{delivery: delivery})
  ...
  def publish_event(topic, payload) do
    CargoShipping.ApplicationEvents.Producer.publish_event(topic, "CargoInspectionService", payload)
  end
end
